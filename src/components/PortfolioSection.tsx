    ...
    <section id="portfolio" className="bg-studio-white/50 py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-8">
            <Button 
              ...
              className={filter === "all" ? "bg-studio-green text-white" : ""}
            >
              All Projects
            </Button>
            <Button 
              ...
              className={filter === "residential" ? "bg-studio-green text-white" : ""}
            >
              Residential
            </Button>
            <Button 
              ...
              className={filter === "commercial" ? "bg-studio-green text-white" : ""}
            >
              Commercial
            </Button>
            <Button 
              ...
              className={filter === "hospitality" ? "bg-studio-green text-white" : ""}
            >
              Hospitality
            </Button>
          </div>
        ...
        <div className="text-center mt-12">
          <Button className="bg-studio-charcoal hover:bg-studio-charcoal/90 text-white">
            View All Projects
          </Button>
        </div>
      </div>
